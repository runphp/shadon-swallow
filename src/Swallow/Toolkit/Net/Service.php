...
class Service
{
    ...
    public function exec()
    {
        ...
        $accountData = json_encode(array('account' => $this->config['account'], 'secret_key' => $this->config['secret_key']));
        ...
        if ('200' != $httpCode) {
            return array('status' => 500, 'info' => APP_DEBUG ? $content : '系统繁忙，程序猿正在玩命优化哦~', 'retval' => '');
        }
