...
interface StatusCode
{
    ...
    const ACCESS_TOKEN_INVALID = 707;
     /**
     * user_access_token 用户失效
     *
     * @var int
     */
    const USER_ACCESS_TOKEN_INVALID = 708;
     ...
     * @var int
     */
    const LIMITED_FUNCTIONALITY = 711;
}